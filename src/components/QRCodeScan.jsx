...
const QRCodeScan = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white text-black p-6">
      {/* Heading */}
      <h1 className="text-xl font-bold mb-4">Scan Previous Shift's Operator’s QR Code</h1>

      {/* QR Scanner */}
      <div id="qr-reader" className="w-full max-w-md bg-gray-200 p-4 rounded-lg shadow-md"></div>
      ...
      {scanResult && <p className="mt-4 text-green-400 font-semibold">Scanned: {scanResult}</p>}
    </div>
  );
};
