  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <div className="flex-grow flex flex-col items-center justify-center py-12 px-4">
        ...
        <img src="/assets/kanta-king-logo.svg" alt="Kanta King Logo" className="h-17 mb-6" />
        ...
        <h2 className="text-xl font-bold text-black text-center">
          ✅ Attendance Marked Successfully, <span className="text-black">{employeeName}</span>!
        </h2>

        {/* Employee Details */}
        <div className="bg-gray-100 p-4 rounded-lg shadow-md w-full max-w-sm text-center mt-4">
          <p className="text-gray-700"><strong>Employee ID:</strong> {employeeID}</p>
          <p className="text-gray-700"><strong>Designation:</strong> {designation}</p>
          <p className="text-gray-700"><strong>Date & Time:</strong> {attendanceTime}</p>
          <p className="text-gray-700"><strong>Location:</strong> {userLat}, {userLng}</p>
        </div>
